...
object Dependencies {
  ...
  object Versions {
    ...
    val scalaTestV    = "3.2.10"      //https://github.com/scalatest/scalatest/releases
    val scalaTestPlusV= "3.2.10.0"  //https://github.com/scalatest/scalatestplus-scalacheck
    val http4sV       = "1.0.0-M29"   //https://github.com/http4s/http4s/releases
    ...
    val fs2Version    = "3.2.3"        //https://github.com/functional-streams-for-scala/fs2/releases

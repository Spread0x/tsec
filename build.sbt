...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/Spread0x/tsec"),
        "git@github.com:Spread0x/tsec.git"
      )
    ),
    homepage := Some(url("https://github.com/Spread0x/tsec")),
...
lazy val micrositeSettings = Seq(
  ...
  micrositeHomepage := "https://spread0x.github.io/tsec/",
  micrositeGithubOwner := "Spread0x",
...
lazy val commonSettings = Seq(
  ...
  ThisBuild / organization := "io.github.spread0x",
  ...
  //     "-doc-source-url", "https://github.com/spread0x/tsec/blob/v" + version.value + "€{FILE_PATH}.scala"
  // ),
...
lazy val publishSettings = Seq(
  ...
  scmInfo := Some(ScmInfo(url("https://github.com/Spread0x/tsec"), "scm:git:git@github.com:Spread0x/tsec.git")),
)
